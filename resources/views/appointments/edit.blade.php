                    ...
                    <form action="{{ route('appointments.update', $appointment->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('schedule_id') is-invalid @enderror" id="schedule_id" name="schedule_id" required>
                                ...
                                @foreach ($schedules as $schedule)
                                    <option value="{{ $schedule->id }}" {{ old('schedule_id', $appointment->schedule_id) == $schedule->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="time" class="form-control @error('appointment_time') is-invalid @enderror" id="appointment_time" name="appointment_time" value="{{ old('appointment_time', substr($appointment->appointment_time, 0, 5)) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                ...
                                <option value="scheduled" {{ old('status', $appointment->status) == 'scheduled' ? 'selected' : '' }}>Terjadwal</option>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('symptoms') is-invalid @enderror" id="symptoms" name="symptoms" rows="3">{{ old('symptoms', $appointment->symptoms) }}</textarea>
                            @error('symptoms')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
