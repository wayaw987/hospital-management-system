        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">
                        <i class="fas fa-user-plus"></i> Lengkapi Data Diri Sebagai Pasien
                    </h4>
                </div>
                <div class="card-body">
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i>
                        <strong>Selamat datang!</strong> Untuk dapat membuat appointment, silakan lengkapi data diri Anda sebagai pasien. 
                        Data ini akan ditinjau oleh admin sebelum disetujui.
                    </div>

                    <form method="POST" action="{{ route('patient.request.store') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="emergency_contact_phone" class="form-label">Telepon Kontak Darurat <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('medical_history') is-invalid @enderror" 
                                      ...
                                      placeholder="Riwayat penyakit, alergi, atau kondisi medis lainnya">{{ old('medical_history') }}</textarea>
